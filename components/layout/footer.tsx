    ...
    <footer className="relative mt-24">
      <Container className="pb-12 pt-16">
        <div className="glass-panel rounded-2xl p-8 md:p-10">
          ...
          <div className="mt-10 flex flex-col items-start justify-between gap-4 text-xs text-muted-foreground sm:flex-row sm:items-center">
            <p>
...
function SocialIcon({
  ...
  return (
    <Link
      href={href}
      aria-label={label}
      className="inline-flex h-8 w-8 items-center justify-center rounded-md border border-border/70 bg-card/40 text-muted-foreground transition-all hover:border-accent/50 hover:text-accent"
    >
      {children}
    </Link>
  )
